...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Área quadrado: " + areaPrimeiroQuadrado);
		...
		System.out.println("Área retângulo: " + areaPrimeiroRetangulo);
		...
		System.out.println("Área círculo: " + areaPrimeiroCirculo);
		...
		System.out.println("Área triângulo: " + areaPrimeiroTriangulo);
		
		System.out.println("Desenho triângulo: ");
